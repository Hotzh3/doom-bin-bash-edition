...
|----|--------|----------|------------------|-----------------------------------|---------|-------|-------------------|----------------------------------------|
| **21-A1** | **Auditoría + baseline** | Fijar métricas, mapa de deuda y reglas de parada en este doc; **sin cambio de TS** | `docs/phases/phase-21-runtime-budget.md` (y referencias) | Ninguna movida; solo transparencia | Bajo | `npm test` + lint + build como sanidad del repo | Ninguna obligatoria | `docs(phase21): add structural audit baseline` |
